...
public class UnEmployment extends Base {
    ...
    public Double getPayBase() { return payBase; }
    public void setPayBase(Double payBase) { this.payBase = payBase; }
    public Double getPersonalPay() { return personalPay; }
    public void setPersonalPay(Double personalPay) { this.personalPay = personalPay; }
    public Double getUnitPay() { return unitPay; }
    public void setUnitPay(Double unitPay) { this.unitPay = unitPay; }
    public Double getTotalPay() { return totalPay; }
    public void setTotalPay(Double totalPay) { this.totalPay = totalPay; }
    public Double getPersonalReserved() { return personalReserved; }
    public void setPersonalReserved(Double personalReserved) { this.personalReserved = personalReserved; }
