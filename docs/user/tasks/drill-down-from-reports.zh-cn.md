...
- FinSight v2.0.2+（语义下钻）。

---

## 步骤

1. 打开报表，如 **Fixed vs Variable** 或 **Spending Drift**（`/app/reports/*`）。

2. 设置 **Period**（可选 Card / Category 筛选）。

3. 点击 **饼图切片** 或 **表格行**（如 Dining、Housing）。
...
| 语义下钻 | 按 **Reporting Classification**，非旧版仅 expense 过滤 |
...
- Spending Drift：点击对应期别的柱（当前期 / 对比期）。
